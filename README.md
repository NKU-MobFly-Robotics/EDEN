...
$ roslaunch single_exp exploration.launch
```

Mamba bless your UAV!

## 3. Parameters
Find yaml files in [resource](./EDEN/Exploration/single_exp/resource/) dir.  
...
[RipNeon](./EDEN/Mapping/RipNeon/) bag = Dynamic Voxel Map  
...
Thank [Zikang Yuan](https://github.com/ZikangYuan) for raising many problems, which help find bugs.
